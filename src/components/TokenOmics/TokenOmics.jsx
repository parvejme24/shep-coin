      ...
      <div className="max-w-7xl px-5 container mx-auto">
        ...
        <div className="max-w-[800px] mx-auto relative font-halodick text-white tracking-wide">
          <img
            ...
            className="mx-auto py-16 md:py-32 w-1/2"
          />

          {/* Text Positioning */}
          <div className="absolute top-1/4 sm:top-16 left-1/2 transform -translate-x-1/2 text-center px-4">
            <p className="text-sm sm:text-base md:text-lg">
              Marketing & Partnerships: <br /> 5% (5 billion)
            </p>
          </div>

          <div className="absolute top-1/2 sm:top-1/3 left-5 text-center px-4">
            <p className="text-sm sm:text-base md:text-lg">
              Staking Rewards: <br /> 15% (15 billion)
            </p>
          </div>

          <div className="absolute top-1/2 sm:top-1/3 right-5 text-center px-4">
            <p className="text-sm sm:text-base md:text-lg">
              Airdrop: <br /> 20% (20 billion)
            </p>
          </div>

          <div className="absolute top-3/4 sm:top-1/2 left-5 text-center px-4">
            <p className="text-sm sm:text-base md:text-lg">
              Pre-Sale: <br /> 30% (30 billion)
            </p>
          </div>

          <div className="absolute top-4/5 sm:top-3/4 right-5 text-center px-4">
            <p className="text-sm sm:text-base md:text-lg">
        ...
        <p className="text-center font-halodick text-white mt-10 px-4">
